<template>
    <el-button class="pointer box-hover action-item" size="small" @click="showDialog = true">
        详情
    </el-button>
    <base-dialog v-model:visible="showDialog" top="80px" title="" class="search-dialog" min-height="200px" width="750px"
        append-to-body="true">
        ...
        <div class="nav-search-list mt15" v-if="searchList.length > 0">
            <div class="nav-search-item flex-row-center justify-between" :class="{ active: index === activeIndex }"
                v-for="(item, index) in searchList" :key="item.name" @click="handleRedirect"
